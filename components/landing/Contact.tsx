      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 size-full  max-w-7xl lg:items-stretch">
        ...
        <div className="flex flex-col md:flex-row relative gap-4 items-center justify-center lg:flex-1 ">
          <Link
            ...
            className="group bg-linear-to-l from-slate-800 via-primary-40 to-secondary border-2 border-secondary/30 h-80 w-full overflow-hidden relative flex items-center justify-center rounded-3xl "
          >
            <img
