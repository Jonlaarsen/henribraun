          ...
          {TJANSTER_LIST.map((service) => {
            ...
            return (
              <Link
                ...
                className="block z-10 p-6 rounded-2xl border bg-linear-to-br from-white/30 via-gray-200/30 to-white/30 backdrop-blur-xs border-black/10 hover:border-black/20 hover:scale-105 hover:bg-black/[0.02] hover:shadow-xl transition-colors"
              >
